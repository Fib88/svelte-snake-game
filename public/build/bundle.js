...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "eyes svelte-t6ede8");
    			add_location(div0, file, 45, 2, 691);
    			attr_dev(div1, "id", "rightEye");
    			attr_dev(div1, "class", "eyes svelte-t6ede8");
    			add_location(div1, file, 46, 2, 727);
    			attr_dev(div2, "class", "snake-body right svelte-t6ede8");
    			add_location(div2, file, 44, 0, 658);
    		},
    ...
    function create_fragment$1(ctx) {
    	let current;
    	const snakebody = new SnakeBody({ $$inline: true });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "food svelte-oi374j");
    			add_location(div, file$1, 18, 0, 241);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	let h2;
    	let current;
    	const snake = new Snake({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1wfeo8w");
    			add_location(h1, file$2, 44, 0, 788);
    			attr_dev(main, "class", "svelte-1wfeo8w");
    			add_location(main, file$2, 45, 0, 808);
    			attr_dev(h2, "class", "svelte-1wfeo8w");
    			add_location(h2, file$2, 49, 0, 846);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
